...
import { Modal, Button, Tabs, Form, Input, Upload, DatePicker, Select } from 'antd';
...
export const CertForm = ({ visible, onCancel }) => {
    ...
    <Form layout="vertical">
            ...
            <Form.Item
              label="Validated By"
              name="validated_by"
              rules={[{ required: true, message: 'Please enter the validated by' }]}
            >
              <Input />
            </Form.Item>
            <Form.Item
              ...
              rules={[{ required: true, message: 'Please enter the date of validation' }]}
            >
              <Input />
            </Form.Item>
            <Form.Item
